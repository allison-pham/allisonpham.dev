...
const projectSeeds: ProjectSeed[] = [
  {
    id: "metrosync",
    title: "MetroSync",
    description: "Short term travel recommendations (metro, subway, etc.)",
    tags: ["Next.js", "TypeScript", "Mapbox", "General Transit Feed Specification", "OpenTripPlanner", "WebSockets"],
    status: "ideation",
    year: "2026",
    url: "",
    homepage: "",
...

  {
    id: "athletica",
    title: "Athletica",
    description: "Sports logs",
    tags: ["Next.js", "TypeScript", "Chart.js", "Supabase", "Clerk"],
    status: "ideation",
    year: "2026",
    url: "",
    homepage: "",
...

  {
    id: "storyatlas",
    title: "StoryAtlas",
    description: "Simulate book/TV show exploration aspects",
...

  {
    id: "openpath",
    title: "OpenPath",
    description: "Web app for disabilities and mental health",
    tags: ["Next.js", "TypeScript", "React Aria"],
    status: "ideation",
    year: "2026",
    url: "",
    homepage: "",
...

  {
    id: "cortexflow",
    title: "CortexFlow",
    description: "Cybernetics and biometrics",
...

  {
    id: "lexora",
    title: "Lexora",
    description: "Language learning made interactive, gamified, etc.",
    tags: ["Next.js", "TypeScript", "Supabase", "FastAPI", "Prisma", "Clerk"],
    status: "ideation",
    year: "2026",
    url: "",
    homepage: "",
...

  {
    id: "quant-flow",
    title: "QuantFlow",
    description: "Simulated quant market maker for learning and experimentation",
    tags: ["Streamlit", "Python", "NumPy"],
    status: "ideation",
    year: "2026",
    url: "",
    homepage: "",
...

  {
    id: "dexora",
    title: "Dexora",
    description: "Pokédex-inspired app",
    tags: ["Next.js", "TypeScript", "Framer Motion", "Supabase", "PokéAPI"],
    status: "ideation",
    year: "2026",
    url: "",
    homepage: "",
...

  {
    id: "closkin",
    title: "Closkin",
    description: "Fashion closet x skincare collection",
    tags: ["Next.js", "TypeScript", "Framer Motion", "Supabase", "Cloudinary", "Replicate"],
    status: "ideation",
    year: "2026",
    url: "",
    homepage: "",
...

  {
    id: "acadence",
    title: "Acadence",
    description: "Unified academic notification dashboard (web app that includes all notifications from Canvas, Gradescope, zyBooks, etc.)",
...

  {
    ...
    tags: ["Next.js", "TypeScript", "Tailwind CSS", "Supabase", "Clerk", "Figma"],
    status: "in progress",
    year: "2026",
    url: "",
    homepage: "",
...

  {
    ...
    description: "Design systems, frontend development, and product engineering",
...

  {
    id: "terraground",
    title: "TerraGround",
    description: "Emergency system x GIS",
    tags: ["Next.js", "TypeScript", "Mapbox", "FastAPI", "Figma"],
    status: "in progress",
    year: "2026",
...

  {
    ...
    tags: ["Next.js", "TypeScript", "FastAPI", "LangGraph", "Redis", "Figma"],
    status: "in progress",
    year: "2026",
...

  {
    ...
    tags: ["Vue.js", "JavaScript", "shadcn", "Supabase"],
    status: "ideation",
    year: "2026",
    url: "",
    homepage: "",
...

  {
    ...
    tags: ["Streamlit", "Python", "PyTorch", "scikit-learn", "LangChain"],
    status: "ideation",
    year: "2025",
    url: "",
    homepage: "",
...

  {
    ...
    tags: ["Next.js", "TypeScript", "Supabase", "Prisma", "Clerk", "Figma"],
    status: "in progress",
    year: "2025",
...

  {
    ...
    tags: ["Next.js", "TypeScript", "Tailwind CSS", "Supabase", "PyTorch", "WebSockets"],
    status: "in progress",
    year: "2025",
...

  {
    ...
    tags: ["React", "Vite", "JavaScript", "Tailwind CSS", "Figma"],
    status: "in progress",
    year: "2025",
...

  {
    ...
    tags: ["Next.js", "TypeScript", "Supabase", "PostgreSQL", "Prisma", "Kubernetes", "Clerk", "Plaid"],
    status: "archived",
    year: "2025",
    url: "",
    homepage: "",
...

  {
    ...
    tags: ["Next.js", "JavaScript", "Material UI"],
    status: "shipped",
    year: "2024",
...

  {
    ...
    tags: ["Next.js", "JavaScript", "Material UI", "Firebase", "Figma"],
    status: "shipped",
    year: "2024",
