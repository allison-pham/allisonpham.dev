    ...
    <section ref={ref} className="relative px-4 sm:px-6 pt-16 sm:pt-16 pb-8 sm:pb-12">
      <div className={cn("mx-auto max-w-7xl opacity-0", isVisible && "animate-fade-in-up")}>
        <div className="space-y-2 mb-8">
          <p className="font-mono text-xs tracking-[0.25em] sm:tracking-[0.35em] text-primary">play with my brain;</p>
          <h1 className="text-3xl font-bold tracking-tight sm:text-5xl lg:text-6xl text-balance">Playground</h1>
          <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">Tiny experimental games, weird interactions, and interactive visuals to form a playground for curiosity and creativity (a space to explore the playful side of cognition and perception with a sprinkle of chaos)</p>
        </div>
