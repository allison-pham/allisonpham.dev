        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3 mb-6">
          ...
          <div className="space-y-4">
            <div className="space-y-1">
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">
                Design engineering at the intersection of cognition and HCI
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p className="font-mono text-[11px] text-muted-foreground pl-4.5 border-l border-border/50 ml-1">
                currently → hci for space systems + website
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-lg border border-primary/20 bg-primary/5 px-4 py-3">
              ...
              <a href="mailto:apham206@ucr.edu"
                className="group flex items-center gap-2 font-mono text-xs text-primary transition-colors hover:text-foreground">
