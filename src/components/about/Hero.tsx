...
const INITIAL_NOTES: NoteItem[] = [
  {
    id: 1,
    text: "some days the hardest part is just starting.",
    mood: "reflective",
    color: "#ffd6a5",
    rotation: -3,
    x: 20,
  ...
  {
    id: 2,
    text: "i think constraints are secretly gifts.",
    mood: "hopeful",
    color: "#a8d8ea",
    rotation: 2,
    x: 55,
  ...
  {
    id: 3,
    text: "the answer was simpler than i made it.",
    mood: "clarity",
    color: "#d4edda",
    rotation: -1,
    x: 35,
  ...
  {
    id: 4,
    text: "still figuring it out. that's the point.",
    mood: "honest",
    color: "#f7c5c5",
    rotation: 4,
    x: 60,
  ...
  {
    id: 6,
    text: "shipped something imperfect today. proud of it.",
    mood: "hopeful",
    color: "#ffeaa7",
    rotation: 3,
    x: 45,
      ...
      >
        {(
          ...
          <button
            ...
            onClick={() => setView(v)}
            style={{
              background: view === v ? "rgba(124,58,237,0.12)" : "none",
              border: "none",
              cursor: "pointer",
              ...
              <form onSubmit={handleDrop} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                <div style={{ position: "relative" }}>
                  <textarea
                    ...
                    style={{
                      ...
                      lineHeight: 1.7,
                      resize: "none",
                      background: (MOODS.find((m) => m.id === draft.mood)?.color ?? "#fafafa") + "40",
                  ...
                  <span
                    style={{
                      ...
                      fontFamily: "monospace",
                      fontSize: 10,
                      color: draft.text.length > 120 ? "#ef4444" : "#9ca3af",
                    }}
                  >
                    ...
                    {MOODS.map((m) => (
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: 999,
                          background: m.color,
                          border: `2px solid ${draft.mood === m.id ? "rgba(0,0,0,0.3)" : "transparent"}`,
                          fontFamily: "monospace",
                          fontSize: 11,
                          cursor: "pointer",
                          color: "#374151",
                          transition: "all 0.15s",
                          transform: draft.mood === m.id ? "scale(1.05)" : "scale(1)",
                        }}
                      >
                        {m.label}
                      </button>
                ...
                {draft.text && (
                  <div
                    style={{
                      padding: "12px 14px",
                      background: MOODS.find((m) => m.id === draft.mood)?.color ?? "#ffd6a5",
                      borderRadius: 10,
                ...
                <button
                  type="submit"
                  disabled={!draft.text.trim() || dropping}
                  style={{
                    padding: "10px 18px",
                    background: draft.text.trim() ? "rgba(124,58,237,0.1)" : "rgba(0,0,0,0.04)",
                    border: "1px solid",
                    borderColor: draft.text.trim() ? "rgba(124,58,237,0.3)" : "rgba(0,0,0,0.1)",
                    borderRadius: 10,
                    fontFamily: "monospace",
                    fontSize: 12,
                    color: draft.text.trim() ? "#7c3aed" : "#9ca3af",
  ...
  about: {
    ...
    body: (
      <>
        ...
        <p>
          I currently direct{" "}
          <a href="https://www.citrushack.com" target="_blank" rel="noopener noreferrer" className={linkCn}>
            Citrus Hack
          </a>{" "}
          and{" "}
                ...
                <code className="block min-w-max">{`
{
  ...
  "status": "designing products"  
      ...
      {activeModal && <AboutModal type={activeModal} onClose={() => setActiveModal(null)} onSwitch={setActiveModal} />}
    </section>
  );
}
