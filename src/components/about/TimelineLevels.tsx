    ...
    <section className="px-4 sm:px-6 py-20 border-t border-border/40">
      <div className="mx-auto max-w-7xl">
        <div className="space-y-4 mb-10">
          <p className="font-mono text-xs tracking-[0.35em] text-primary">origin story / levels mode;</p>
          <h2 className="text-2xl font-bold tracking-tight sm:text-4xl lg:text-5xl">Life (as Unlockable Stages)</h2>
