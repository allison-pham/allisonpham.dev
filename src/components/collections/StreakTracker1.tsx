...
const habitTrackers: Tracker[] = [
  ...
  { id: "writing",   label: "Writing",    emoji: "✍️", color: "#059669", currentStreak: 5,  longestStreak: 19, totalDays: 63,  data: generateData(0.50), description: "Field notes & brain dumps" },
]
...
const ALL_TABS: Tab[] = [
  ...
  {
    id: "code", label: "Code", emoji: "⬡", color: "#2563eb",
    trackers: [{ id: "code", label: "Code", emoji: "⬡", color: "#2563eb", currentStreak: 6, longestStreak: 31, totalDays: 142, data: generateData(0.70) }],
  },
  {
  ...
  ...habitTrackers.map(t => ({
    id: t.id, label: t.label, emoji: t.emoji, color: t.color,
    trackers: [t],
  })),
]
