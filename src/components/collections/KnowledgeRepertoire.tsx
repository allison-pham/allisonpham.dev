      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className={cn("opacity-0", isVisible && "animate-fade-in-up")}> 
          <div className="space-y-2 mb-8">
            <p className="font-mono text-xs tracking-[0.25em] text-primary flex items-center gap-2">information;</p>
          ...
          <p className="w-full text-base sm:text-lg text-muted-foreground leading-relaxed">
            A living map of the areas and topics I'm passionate about and pursue through learning, projects, etc.
            Features actively learning, what's next / upcoming, and completion.
          </p>
        </div>
